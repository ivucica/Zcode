...
-(id)initWithDictionary:(NSDictionary *)otherDictionary
{
    ...
    {
        buildSettings = [NSMutableDictionary dictionaryWithDictionary:otherDictionary];
    }
    return nil;
}
    ...
    for (int i = 0; i < [currentString length]; i++) 
    {
            ...
            locationOfVariableCloser.location != NSNotFound) 
        {
            ...
            if ([currentDictionary objectForKey:variableName]) 
            {
                ...
                newString = [newString stringByAppendingString:[currentString substringFromIndex:locationOfVariableCloser.location]];
